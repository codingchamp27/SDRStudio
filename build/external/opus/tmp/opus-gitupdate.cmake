...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v1.5.2"
  WORKING_DIRECTORY "/Users/harshkumar/Desktop/sdrangel/build/external/opus/src/opus"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/harshkumar/Desktop/sdrangel/build/external/opus/src/opus'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/harshkumar/Desktop/sdrangel/build/external/opus/src/opus'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
