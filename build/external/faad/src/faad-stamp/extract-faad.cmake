...
#
get_filename_component(filename "/Users/harshkumar/Desktop/sdrangel/build/external/faad/src/faad2-2.8.8.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/harshkumar/Desktop/sdrangel/build/external/faad/src/faad" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-faad${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-faad${i}")
