...
#
get_filename_component(filename "/Users/harshkumar/Desktop/sdrangel/build/external/fftw3f/src/fftw-3.3.10.tar.gz" ABSOLUTE)
get_filename_component(directory "/Users/harshkumar/Desktop/sdrangel/build/external/fftw3f/src/fftw3f" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-fftw3f${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-fftw3f${i}")
